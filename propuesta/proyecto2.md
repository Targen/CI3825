...
<!-- 8.   -->La comunicación entre varios procesos resultantes de una ejecución de `rautomake` sólo podrá hacerse a través de estados de salida y señales del sistema operativo, a menos que uno de los procesos involucrados sea un compilador de C, en cuyo caso es aceptable la comunicación a través de archivos.
